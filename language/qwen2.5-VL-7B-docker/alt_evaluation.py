...
filepath = Path("/home/jcalderon/MLCommons/inference/language/qwen2.5-VL-7B-docker/output/mlperf_log_accuracy.json")

target_path = Path("/home/jcalderon/MLCommons/inference/language/qwen2.5-VL-7B-docker/datasets/mmmu_data.json")
